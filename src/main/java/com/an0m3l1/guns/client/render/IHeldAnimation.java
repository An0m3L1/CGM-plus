...
public interface IHeldAnimation
{
	 ...
	 *
	 * @param hand
	 * 		the hand which is currently being used
	 * @param aimProgress
	 * 		the current animation progress of looking down the weapons sight
	 */
	@OnlyIn(Dist.CLIENT)
	 ...
	 */
	default boolean cantRenderOffhandItem()
	{
		return true;
	}
	 ...
	 *
	 * @param source
	 * 		the model renderer to grab the rotations from
	 * @param dest
	 * 		the model renderer to apply the rotations to
	 */
	@OnlyIn(Dist.CLIENT)
