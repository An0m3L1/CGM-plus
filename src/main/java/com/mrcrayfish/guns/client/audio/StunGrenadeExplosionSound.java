 ...
 * Author: MrCrayfish
 */
public class StunGrenadeExplosionSound extends AbstractSoundInstance
{
    public StunGrenadeExplosionSound(ResourceLocation soundIn, SoundSource categoryIn, float x, float y, float z, float volume, float pitch, RandomSource source)
    {
