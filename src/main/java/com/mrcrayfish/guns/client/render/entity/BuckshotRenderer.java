...
import com.mrcrayfish.guns.entity.projectile.BuckshotEntity;
 ...
 * Author: MrCrayfish
 */
public class BuckshotRenderer extends EntityRenderer<BuckshotEntity>
{
    ...
    @Override
    public ResourceLocation getTextureLocation(BuckshotEntity entity)
    {
        return null;
    }

    @Override
    public void render(BuckshotEntity entity, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource renderTypeBuffer, int light)
    {
