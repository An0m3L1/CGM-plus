...
import com.mrcrayfish.guns.entity.projectile.LightBulletEntity;
 ...
 * Author: MrCrayfish
 */
public class LightBulletRenderer extends EntityRenderer<LightBulletEntity>
{
    public LightBulletRenderer(EntityRendererProvider.Context context)
    {
        super(context);
    }

    @Override
    public ResourceLocation getTextureLocation(LightBulletEntity entity)
    {
        return null;
    }

    @Override
    public void render(LightBulletEntity entity, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource renderTypeBuffer, int light)
    {
