...
public class Debug
{
	...
	public static class Menu implements IEditorMenu
	{
		...
		public void getEditorWidgets(List<Pair<Component, Supplier<IDebugWidget>>> widgets)
		{
			DistExecutor.unsafeRunWhenOn(Dist.CLIENT, () -> () ->
			{
				...
				{
					widgets.add(Pair.of(Component.translatable(gunItem.getDescriptionId()), () -> new DebugButton(Component.literal("Edit"), btn -> Minecraft.getInstance().setScreen(ClientHandler.createEditorScreen(getGun(gunItem))))));
				}
				widgets.add(Pair.of(Component.literal("Settings"), () -> new DebugButton(Component.literal(">"), btn -> Minecraft.getInstance().setScreen(ClientHandler.createEditorScreen(new Settings())))));
			});
		}
	}
	...
	public static class Settings implements IEditorMenu
	{
		...
		public void getEditorWidgets(List<Pair<Component, Supplier<IDebugWidget>>> widgets)
		{
			DistExecutor.unsafeRunWhenOn(Dist.CLIENT, () -> () -> widgets.add(Pair.of(Component.literal("Force Aim"), () -> new DebugToggle(Debug.forceAim, value -> Debug.forceAim = value))));
		}
	}
}
