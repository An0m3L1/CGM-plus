...
public class ModSounds 
{
	...
	/* Explosions */
	public static final RegistryObject<SoundEvent> INCENDIARY_EXTINGUISH = register("entity.incendiary.extinguish");
	...
	/* Other sounds */
	public static final RegistryObject<SoundEvent> DRAW = register("item.draw");
