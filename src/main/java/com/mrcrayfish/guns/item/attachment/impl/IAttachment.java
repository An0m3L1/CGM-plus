...
public interface IAttachment<T extends Attachment>
{
	...
	enum Type
	{
		SCOPE("scope", "Scope", "scope"), BARREL("barrel", "Barrel", "barrel"), STOCK("stock", "Stock", "stock"), UNDER_BARREL("under_barrel", "Under_Barrel", "underBarrel"), TACTICAL("tactical", "Tactical", "tactical"), MAGAZINE("magazine", "Magazine", "magazine");
